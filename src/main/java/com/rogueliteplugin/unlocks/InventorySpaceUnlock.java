...
public class InventorySpaceUnlock implements Unlock {
    ...
    public InventorySpaceUnlock(String id, String name, Icon icon, String description,
    ...
    public UnlockType getType() {
        return UnlockType.InventorySlots;
    }
