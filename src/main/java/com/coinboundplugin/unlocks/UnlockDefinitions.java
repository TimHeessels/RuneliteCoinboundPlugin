...
public final class UnlockDefinitions {
    ...
    public static void registerAll(
        ...
        //TODO: Add special attack bar unlock
        //TODO: Protection prayers as separate unlocks
        //TODO: Low/High alching blocked
        //TODO: Jewelry
        //TODO: Maybe: Doors/ladders/webs?
        ...
        registerHouseArrestBand(registry);
    }

    private static void registerHouseArrestBand(UnlockRegistry registry) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            if (previousSlot != null)
                reqs.add(new UnlockIDRequirement("HouseArrestRange" + previousSlot, registry));

            registry.register(
                    new HouseArrestExpansion(
                            "HouseArrestRange" + (i + 1),
                            "Extend house arrest range (" + String.format("%02d", i + 1) + ")",
                            IconLoader.load("chain.png" ),
                            "Allows you to wander further from the starting area.",
                            reqs
                    )
            );
            previousSlot = i+1;
        ...
        registry.register(
                new HouseArrestExpansion(
                        ...
                        "Remove house arrest",
                        IconLoader.load("chain.png" ),
                        "Allows you to wander everywhere.",
                        reqs
                )
        );
    }
        ...
        for (int i = 1; i < 28; i++) {
            ...
            registry.register(
                    new InventorySpaceUnlock(
                            "InventorySlot" + (i + 1),
                            "Unlock inventory slot " + String.format("%02d", i + 1),
